...
import org.anonomi.postbox.android.ui.StartupFailureActivity.StartupFailure.LIFECYCLE_REUSE
import org.anonomi.postbox.android.ui.StartupFailureActivity.StartupFailure.SERVICE_ERROR

@AndroidEntryPoint
class StartupFailureActivity : AppCompatActivity() {

    companion object {
        var EXTRA_START_RESULT = "org.anonomi.postbox.START_RESULT"
    }
